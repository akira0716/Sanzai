  ...
  return (
    ...
    >
      ...
      <div className="text-center border-b-2 border-gray-300 pb-4">
        <h1 className="text-3xl font-bold text-gray-800">家計簿月別レポート</h1>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">日平均収入</p>
              <p className="text-xl font-semibold text-green-600">
                {formatCurrency(report.dailyAverages.income)}
              </p>
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-600">日平均支出</p>
...
>(({ report }, ref) => {
  return (
    ...
    >
      {/* ヘッダー */}
      <div className="text-center border-b-2 border-gray-300 pb-4">
        <h1 className="text-3xl font-bold text-gray-800">家計簿年間レポート</h1>
        <h2 className="text-xl text-gray-600 mt-2">{report.year}年</h2>
        <p className="text-sm text-gray-500 mt-1">
          生成日時: {new Date().toLocaleString("ja-JP")}
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>年間収支サマリー</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-sm text-gray-600">年間総収入</p>
              <p className="text-2xl font-bold text-green-600">
                {formatCurrency(report.totalIncome)}
              </p>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">年間総支出</p>
              <p className="text-2xl font-bold text-red-600">
                {formatCurrency(report.totalExpense)}
              </p>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">平均月収支</p>
              <p
